              ...
              <div class="dropdown-menu">
                <div class="dropdown-menu-columns">
                  <div class="dropdown-menu-column">
                    <a class="dropdown-item" href="{{route('patientForm')}}">
                      Register OPD Patient
                    </a>
                    <a class="dropdown-item" href="{{route('today_patient_table')}}">
                      Today OPD Patient Table
                    </a>
                    <a class="dropdown-item" href="{{route('all_patient_table')}}">
                      All OPD Patient Table
                    </a>
                  </div>
