...
<div class="container">
    ...
    @endforeach
    <button class="btn btn-primary" onclick="window.print()">Print this page</button>    <button class="btn btn-success"> <a href="{{route('patientForm')}}">New Register</a></button>
